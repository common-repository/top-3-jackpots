...
var Countdown_render_as_hours = function (date) {
    this.el.innerHTML = (date.years * 365 + date.days * 24 + date.hours) + ":" +
        this.leadingZeros(date.min) + ":" +
        this.leadingZeros(date.sec);
};
var Countdown_render_as_days = function (date) {
    var days =  parseInt(date.years * 365 + date.days);
    if (!days){
        days = '';
    }
    if (days == 1 ){
